...
# CONFIGURATION
#########################
species = "salicaceae"  # Change to your species name
methods = {
    "ASTRAL-Pro3": "salicaceae_output_astralpro.tre",
    "TreeQMC": "salicaceae_output_treeqmc.tre",
    "Weighted_ASTRAL": "salicaceae_wastral_output.tre"
}
